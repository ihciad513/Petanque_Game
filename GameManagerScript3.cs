...
public class GameManagerScript3 : MonoBehaviour
{
	...
	void Start()
	{
		...
		script1 = Ball3.GetComponent<Ball3Script>();
	...
	void Update()
	{
		...
		if (secondShot == true)
		{
			if (Prb2.IsSleeping())
			{
				...
				if (BPD1 > BPD2 == true)
				{
					...
					if (enemycount3 == 2 && Erb2.IsSleeping())
					{
						if (Player > Enemy)
						{
		...
		if (thirdShot == true)
		{
			if (Prb3.IsSleeping())
			{
				...
				if (Player > BPD3 == true)
				{
                    ...
                    if(Player < BED1 == true && enemycount3 == 1)
                    {
					...
					if (count3 == 3 && enemycount3 == 2 && thirdShot == true)//PEPEP→E
					{
				...
				if (count3 == 3 && enemycount3 == 3 && Erb3.IsSleeping())//双方投げ切り
				{
					if (Player > Enemy)
					{
                    ...
                    {
						ScoreCount();
						PlayerPrefs.SetInt("PS3", scorecount);
		...
		if (thirdShotEnemy == true)
		{
			...
			if (Erb3.IsSleeping())
			{
				...
				if (count3 == 1 && enemycount3 == 3)
				{
					
					Trueplayer = true;//PEEE→P
					FifthTurn();
				}
				if (count3 == 2 && enemycount3 == 3)
				{
					
					Trueplayer = true;//PEEEP→P
					SixthTurn();
					if (count3 == 3 && Prb3.IsSleeping())
					{
						ScoreCount();
						PlayerPrefs.SetInt("PS3", scorecount);
						SceneManager.LoadScene("WinScene3");
				...
				if (count3 == 3 && enemycount3 == 3)//双方投げ切り
				{
					if (Player > Enemy)
					{
	...
	void FourthTurn()
	{
		...
		count3 += 1;
			if (count3 == 1)
			{
				if (shotbutton == true)
				{
					...
					player1 = Instantiate(Ball3, this.transform.position+this.transform.forward, Quaternion.Euler(new Vector3(0f, 45, 0f))) as GameObject;
			...
			if (shotbutton == true)
				...
				player2 = Instantiate(Ball3, this.transform.position, Quaternion.Euler(new Vector3(0f,45,0f))) as GameObject;
			...
			if (count3 == 3)
			{
				...
				player3 = Instantiate(Ball3, this.transform.position, Quaternion.Euler(new Vector3(0f, 45, 0f))) as GameObject;
		...
		private void ThrowingBall()
		{
			...
			if (enemycount3 == 1 && Erb1.IsSleeping())
			{
				enemycount3 += 1;
				float y = Random.Range(3.0f, 15.0f);
				float z = Random.Range(3.0f, 15.0f);
